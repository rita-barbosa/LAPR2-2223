...
| Step 3: selects acceptanceAnswer                                                                                     | ... saving the selected answer?                                              | AcceptOrderUI         | Pure Fabrication: there is no reason to assign this responsibility to any existing class in the Domain Model.                 |
| Step 4: asks to confirm acceptanceAnswer and submit data                                                             | ... displaying the UI for the actor to input data?                           | AcceptOrderUI         | Pure Fabrication: there is no reason to assign this responsibility to any existing class in the Domain Model.                 |
| Step 5: submits data                                                                                                 | ... obtaining the announcement ID from the announcementDto?                  | AnnouncementDto       | DTO pattern                                                                                                                   |
...
|                                                                                                                      | ... getting the announcement instance that has the specified id.             | AnnouncementList      | Information Expert: knows its own announcements.                                                                              |
