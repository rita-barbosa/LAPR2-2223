...
| Step 5: submits data                                                                                                 | ... retrieving the agency that owns announcement with specified ID?          | AgencyRepository      | Information Expert: contains all the agencies; Pure Fabrication.                                                              |
