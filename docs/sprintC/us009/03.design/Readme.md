...
| Step 4: selects filters for the announcement list | ... sorting the orders by choosen filter?                                  | AnnouncementList        | Delegation/Pure Fabrication: promoting Collection from Announcement to specific class to ensure Low Coupling & High Cohesion.            |
...
|                                                   | ... retriving the user's email?                                            | AuthRepository          | Information Expert: contains all users; Pure Fabrication.                                                                                |
