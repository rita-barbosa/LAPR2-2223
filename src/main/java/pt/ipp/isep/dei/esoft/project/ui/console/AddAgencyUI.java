...
public class AddAgencyUI implements Runnable{

    private final AgencyController controller;
    private String name;
    ...
    private AgencyController getController() {
        return controller;
    }
    ...
    private void submitData() {
        Boolean success = getController().createAgency(name, passportCardNumber, taxNumber, emailAddress,
