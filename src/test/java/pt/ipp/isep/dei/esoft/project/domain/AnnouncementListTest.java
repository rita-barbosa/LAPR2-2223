...
//        Request request = new Request(ownerEmail, property, new Business("sale", 2345.0), LocalDate.now(), employee);
//
//        Announcement announcement = new Announcement(employee, commission, request, LocalDate.now(), orderList, 0, 15200.3, LocalDate.of(2023, 1, 14));
//        announcementList.addAnnouncement(announcement);
...
//        orderList.addOrder(o1);
//
//        Announcement announcement = new Announcement(employee, commission, request, LocalDate.of(2022, 1, 1), orderList, 0, 15200.3, LocalDate.of(2023, 1, 14));
//        Announcement announcement1 = new Announcement(employee, commission, request1, LocalDate.of(2022, 3, 1), orderList, 0, 15200.3, LocalDate.of(2023, 1, 14));
//
