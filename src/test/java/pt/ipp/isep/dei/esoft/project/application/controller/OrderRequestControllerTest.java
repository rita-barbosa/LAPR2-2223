...
class OrderRequestControllerTest {
    ...
    void orderRequest() {
        ...
        OrderRequestController controller =
                new OrderRequestController(agencyRepository, personRepository, criteriaRepository, authenticationRepository, propertyTypeRepository, businessTypeRepository);
        ...
        assertEquals(controller.orderRequest(announcement, (163.8)), OrderRequestResult.SUCCESS);
    }
