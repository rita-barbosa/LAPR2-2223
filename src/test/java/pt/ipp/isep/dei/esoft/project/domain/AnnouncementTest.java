...
class AnnouncementTest {
    ...
    void testEqualsDifferentObject() {
        ...
        Property property1 = new Property(new PropertyType("land"), (35.5), (89.3),
                uriList, "street1", "city1", "district1", "st", "12351");
    ...
    void testHashCodeDifferentObject() {
        ...
        Property property = new Property(new PropertyType("land"), (35.5), (89.3),
                uriList, "street", "city", "district", "st", "12345");
        Property property1 = new Property(new PropertyType("land"), (35.5), (89.3),
                uriList, "street1", "city1", "district1", "st", "12341");
    ...
    void ensureGetIdWorks() {
        ...
        Announcement announcement = new Announcement(employee, commission, request, acceptanceDate, orderList, 0, 15200.3, LocalDate.of(2023, 1, 14),null);
